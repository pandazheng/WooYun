...
class DdViewController: UIViewController , UITableViewDataSource , UITableViewDelegate{
    
    var dataBug : NSArray = NSArray()
    
    @IBOutlet weak var tableView : UITableView!
    
    let Url = "http://apis.baidu.com/apistore/wooyun/unclaim"
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("DdDetailCell", forIndexPath: indexPath) as! UITableViewCell
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "goToDetail"
        {
            ...
            let webViewDetailController = segue.destinationViewController as! DdDetailViewController
